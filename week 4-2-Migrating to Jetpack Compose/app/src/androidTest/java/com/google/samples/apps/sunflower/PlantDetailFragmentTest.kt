...
//            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
        // PlantDescription 부분이 compose 로 변경 되었기 때문에 compose assertion 으로 변경되어야 함
        activityTestRule
            .onNodeWithText("Apple") // ViewMatchers.withText("Apple")
            .assertIsDisplayed() // ViewAssertions.matches(ViewMatchers.isDisplayed())
    }
